...
const Footer = () => {
  return (
    <footer className="footer footer-horizontal footer-center bg-[#0B0B0B] rounded-2xl text-primary-content p-10 mt-10">
      <aside>
        <FooterLogo />
        <p className="text-sm text-[#DADADA]/50 ">
          Enjoy fast, reliable parcel delivery with real-time tracking <br />
          and zero hassle. From personal packages to business shipments — we
          deliver on time, every time.
        </p>
      </aside>
      <hr className="border-t border-[#DADADA]/50 border-dashed w-full" />
